...
# 2 (Insertion of ''overweight'' column and BMI calculation, 0 = good <25 BMI, 1= bad >25 BMI)
...
# 3 Data normalization 0 = good, 1 = bad
# 4Normalization of 'cholesterol' column
for index, row in df.iterrows():
...
# 4 Normalization of 'gluc' column       
for index, row in df.iterrows():
    if row['gluc'] <= 1:
        df.at[index, 'gluc'] = 0
    else:
